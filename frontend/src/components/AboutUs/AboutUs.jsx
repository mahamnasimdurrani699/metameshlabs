  ...
  return (
    <div className="w-full min-h-screen text-white flex flex-col items-center py-16 px-6 md:px-20 bg-gradient-to-b from-[#050d1a] via-[#0a1e33] to-[#0d3b5c]">
      ...
      >
        ...
        <p className="text-gray-300 text-lg">
          We are passionate about using AI to automate your business, translating needs into technical solutions, reducing operational costs, and increasing productivity with minimal human effort.
        </p>
      </motion.div>
      ...
      <div className="flex flex-col md:flex-row items-center gap-10 md:gap-20 w-full max-w-6xl">
        ...
        >
          <div className="relative group">
            <img
              src={about_img}
              alt="About Us"
              className="w-full h-[350px] object-cover rounded-2xl shadow-[0_0_15px_rgba(3,114,250,0.6)] group-hover:scale-105 transition-transform duration-300"
            />
            <div className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-20 transition duration-300 bg-gradient-to-tr from-blue-500 to-cyan-400 blur-xl"></div>
          </div>
        </motion.div>
        ...
        >
          ...
          <p className="text-gray-300 mb-6 leading-relaxed">
            At <span className="text-blue-400 font-semibold">Metamesh Labs</span>, we empower businesses to stay ahead in the digital economy with AI, automation, and modern tools.
          </p>
