...
// 🔥 SUPER LIGHTWEIGHT ANIMATION WRAPPER
const SmoothFade = ({ children }) => (
  <m.div
...
function App() {
  ...
  // Smooth active-section tracking (very lightweight)
  useEffect(() => {
    if (!isMounted) return;
  ...
  }, [isScrolling, isMounted, sectionsConfig]);
  ...
  return (
    <React.Suspense fallback={<LoadingPlaceholder />}>
      ...
      {/* 🔥 All other sections wrapped inside smooth lightweight animation */}
      <LazyMotion features={domAnimation}>
        <div ref={about_ref}>
          <SmoothFade>
            <MemoizedAboutUs />
